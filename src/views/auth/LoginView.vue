    ...
    <div class="q-pa-xl">
      <q-card class="my-card">
        <q-card-section>
          ...
          <div class="q-mt-md">
            <q-btn :loading="loading" no-caps outline @click="handleGoogleLogin">
          ...
          <div class="q-mt-md">
            <q-btn :loading="loading" no-caps outline @click="handleMicrosoftLogin">
              <template v-slot:default>
                <div class="row no-wrap">
                  <q-icon
          ...
          <div class="row items-center justify-center q-mt-md">
            ...
            <q-btn to="/register" color="primary" label="Register" flat />
          </div>
        </q-card-section>
      </q-card>
    </div>
